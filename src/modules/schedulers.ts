...
const asukaLink =
  "https://tbnaluslgxzikblascgb.supabase.co/storage/v1/object/sign/passoca/images/asuka.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwYXNzb2NhL2ltYWdlcy9hc3VrYS5wbmciLCJpYXQiOjE3MDY5OTMxNTYsImV4cCI6MTgwMTYwMTE1Nn0.GzozMedbpWDxqWES8JfxUH_jya3hvs9gCdszBQWzpSM&t=2024-02-03T20%3A45%3A56.916Z";
...
export const addSchedulers = (bot: Bot) => {
  ...
  cron.schedule("0 20 * * 5", () => {
    console.log("Sent roleta scheduled");
    bot.api.sendVideo(data.PUCUNAID, asukaLink);
  });
